...
public sealed class OidTranslator : IOidTranslator
{
    ...
    private static readonly Dictionary<string, (string Name, string Desc)> HpOids = new()
    {
        ...
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.1.1.0"] = ("hp-fsDeviceName.0",         "HP FutureSmart device name."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.1.2.0"] = ("hp-fsDeviceDescription.0",  "HP device description string."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.1.3.0"] = ("hp-fsDeviceAssetNumber.0",  "Asset/inventory number."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.1.4.0"] = ("hp-fsDeviceLocation.0",     "Device physical location."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.1.5.0"] = ("hp-fsDeviceContact.0",      "Device contact person."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.1.7.0"] = ("hp-fsDeviceModelNumber.0",  "Device model number."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.1.8.0"] = ("hp-fsDeviceSerialNumber.0", "Device serial number (FutureSmart)."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.1.10.0"]= ("hp-fsDeviceFWVersion.0",    "Firmware version string."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.1.11.0"]= ("hp-fsDeviceSKU.0",          "Product SKU / part number."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.1.14.0"]= ("hp-fsFirmwareDateCode.0",   "Firmware build date code."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.1.16.0"]= ("hp-fsDeviceUUID.0",         "Device unique identifier (UUID)."),

        // ── FutureSmart — Status ───────────────────────────────────────────────
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.2.1.0"] = ("hp-fsDeviceStatus.0",          "Overall device status: idle(1) processing(2) stopped(3) other(4)."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.2.2.0"] = ("hp-fsSubunitStatus.0",         "Subunit status code."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.2.3.0"] = ("hp-fsDeviceCondition.0",       "Device condition code."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.2.4.0"] = ("hp-fsDeviceStatusDescription.0","Status description string."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.2.5.0"] = ("hp-fsDevicePercentDone.0",     "Job completion percentage."),

        // ── FutureSmart — Printer counters ────────────────────────────────────
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.4.1.1.4.0"] = ("hp-fsPrintEngineLifetimeCount.0","Total pages printed (lifetime counter)."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.4.1.1.5.0"] = ("hp-fsPrintEnginePowerCycles.0", "Power cycle count."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.4.1.1.6.0"] = ("hp-fsPrintEngineJamCount.0",    "Paper jam count."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.1.4.1.1.7.0"] = ("hp-fsScannerLifetimeCount.0",   "Scanner page count (MFP)."),
        ...
        ["1.3.6.1.4.1.11.2.3.9.4.2.2.1.1.1.0"]  = ("hp-fsNetworkIPv4Address.0",    "JetDirect IPv4 address."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.2.1.1.2.0"]  = ("hp-fsNetworkSubnetMask.0",     "JetDirect subnet mask."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.2.1.1.3.0"]  = ("hp-fsNetworkDefaultGW.0",      "JetDirect default gateway."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.2.1.1.4.0"]  = ("hp-fsNetworkConfigBy.0",       "Network config method: bootp(1) dhcp(2) manual(3)."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.2.1.1.5.0"]  = ("hp-fsNetworkMACAddress.0",     "JetDirect MAC address."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.2.1.1.6.0"]  = ("hp-fsNetworkHostname.0",       "JetDirect hostname."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.2.1.1.7.0"]  = ("hp-fsNetworkIPv6Address.0",    "JetDirect IPv6 address."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.2.1.1.9.0"]  = ("hp-fsNetworkLinkSpeed.0",      "Network link speed in Mbps."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.2.1.1.10.0"] = ("hp-fsNetworkDuplexMode.0",     "Duplex: fullDuplex(1) halfDuplex(2) auto(3)."),

        // ── FutureSmart — Security / EWS ─────────────────────────────────────
        ["1.3.6.1.4.1.11.2.3.9.4.2.3.1.1.0"]    = ("hp-fsEWSEnabled.0",            "Embedded web server enabled (true/false)."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.3.2.1.0"]    = ("hp-fsSNMPv1v2Enabled.0",       "SNMPv1/v2c read access enabled."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.3.2.2.0"]    = ("hp-fsSNMPv3Enabled.0",         "SNMPv3 enabled."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.3.2.3.0"]    = ("hp-fsSNMPWriteEnabled.0",      "SNMP write (SET) enabled."),
        ["1.3.6.1.4.1.11.2.3.9.4.2.3.3.1.0"]    = ("hp-fsAdminPasswordSet.0",      "Admin password configured (true/false)."),

        // ── HP JetDirect legacy (pre-FutureSmart, still present on most devices) ──
        ["1.3.6.1.4.1.11.2.4.3.1.1.0"]  = ("hp-jdStatus.0",              "JetDirect overall status."),
        ["1.3.6.1.4.1.11.2.4.3.1.2.0"]  = ("hp-jdModelNumber.0",         "JetDirect model number."),
        ["1.3.6.1.4.1.11.2.4.3.1.3.0"]  = ("hp-jdSerialNumber.0",        "JetDirect serial number."),
        ["1.3.6.1.4.1.11.2.4.3.1.4.0"]  = ("hp-jdFirmwareVersion.0",     "JetDirect firmware version."),
        ["1.3.6.1.4.1.11.2.4.3.1.5.0"]  = ("hp-jdMACAddress.0",          "JetDirect MAC address."),
        ["1.3.6.1.4.1.11.2.4.3.1.6.0"]  = ("hp-jdIPAddress.0",           "JetDirect IP address."),
        ["1.3.6.1.4.1.11.2.4.3.1.7.0"]  = ("hp-jdSubnetMask.0",          "JetDirect subnet mask."),
        ["1.3.6.1.4.1.11.2.4.3.1.8.0"]  = ("hp-jdDefaultGateway.0",      "JetDirect default gateway."),
        ["1.3.6.1.4.1.11.2.4.3.1.9.0"]  = ("hp-jdDHCPEnabled.0",         "DHCP enabled (1=yes 2=no)."),
        ["1.3.6.1.4.1.11.2.4.3.5.1.0"]  = ("hp-jdPrintPageCount.0",      "Total pages printed (JetDirect)."),
        ["1.3.6.1.4.1.11.2.4.3.5.2.0"]  = ("hp-jdPrintErrors.0",         "Print error count."),
        ["1.3.6.1.4.1.11.2.4.3.7.1.1.0"]= ("hp-jdTonerBlackLevel.0",     "Black toner level percent."),
        ["1.3.6.1.4.1.11.2.4.3.7.1.2.0"]= ("hp-jdTonerCyanLevel.0",      "Cyan toner level percent."),
        ["1.3.6.1.4.1.11.2.4.3.7.1.3.0"]= ("hp-jdTonerMagentaLevel.0",   "Magenta toner level percent."),
        ["1.3.6.1.4.1.11.2.4.3.7.1.4.0"]= ("hp-jdTonerYellowLevel.0",    "Yellow toner level percent."),
    ...
    private static readonly Dictionary<string, (string Name, string Desc)> CiscoOids = new()
    {
        ...
        ["1.3.6.1.4.1.9.9.43.1.1.1.0"]     = ("ccmHistoryRunningLastChanged.0","sysUpTime of last running-config change."),
        ["1.3.6.1.4.1.9.9.43.1.1.2.0"]     = ("ccmHistoryRunningLastSaved.0",  "sysUpTime of last running-config save."),
        ["1.3.6.1.4.1.9.9.43.1.1.3.0"]     = ("ccmHistoryStartupLastChanged.0","sysUpTime of last startup-config change."),
        ...
        ["1.3.6.1.4.1.9.9.168.1.1.1.0"]    = ("cntpSysSyncStatus.0",       "NTP sync status: synced(1) notSynced(2)."),
        ["1.3.6.1.4.1.9.9.168.1.1.2.0"]    = ("cntpSysPeerAddress.0",      "NTP stratum 1 peer address."),
        ["1.3.6.1.4.1.9.9.168.1.1.8.0"]    = ("cntpSysStratum.0",          "NTP stratum level (1=best, 16=unsync)."),
